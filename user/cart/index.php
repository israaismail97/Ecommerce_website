<?php
    ...
    $sql= "SELECT products.*, product_images.id as images_id, product_images.image, product_images.product_id from products JOIN product_images on products.id= product_images.product_id JOIN cart on products.id= cart.product_id where cart.user_id=".$_SESSION['data']['id']; 
