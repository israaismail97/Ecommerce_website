<?php 
   ...
   # Fetch Data to id .
   $sql= "SELECT products.*, product_images.id as images_id, product_images.image, product_images.product_id from products LEFT JOIN product_images on products.id= product_images.product_id where products.category_id = ".$id;
